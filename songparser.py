    ...
    for file in files:
        if file.endswith(".html"):
            try: 
                ...
                r = tree.xpath("//h3[@class='track_name']//a[@class='track']/@href")
                for elem in r :
                    print(elem)
